...
def print_game_info(game_state):
    ...
    print(U.P1+" score: {}".format(game_state[GS.SCORE_ALPHA]))
    print(U.P2+" score: {}".format(game_state[GS.SCORE_BETA]))
