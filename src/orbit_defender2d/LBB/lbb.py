...
# 2. parameters are immutable within a LBBGame instance
LBBGameInputArgs = namedtuple('LBBGameInputArgs',[
    'max_ring', 
    'min_ring', 
    'geo_ring',
    'init_board_pattern',
...
class LBBGame:
    ''' object that encodes the state and rules of the Lady-Bandit-Bodyguard (LBB) game
